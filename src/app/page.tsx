      ...
      >
        <div className="max-w-6xl w-full mx-auto flex-grow flex flex-col justify-center space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Right Column: Cardboard Box Graphic + Floating Badges */}
            <div className="lg:col-span-5 flex flex-col items-center justify-center relative mt-6 lg:mt-0">
              <div className="w-full max-w-[360px] aspect-square relative text-[#0E1F38]">
                {/* SVG Cardboard Box Graphic */}
                <svg viewBox="0 0 400 400" className="w-full h-full fill-none stroke-current" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {/* Layo logo text printed on box front panel */}
                  <text x="240" y="275" fontSize="28" fontWeight="900" fill="#FF5A65" stroke="none" transform="rotate(-15 240 275)" opacity="0.95">Layo</text>
                  <path d="M 110,215 H 125 V 230 M 110,230 H 125" stroke="#FF5A65" strokeWidth="3" opacity="0.8" />
                </svg>
