...
ADD COLUMN IF NOT EXISTS advance_pct NUMERIC DEFAULT 20,
ADD COLUMN IF NOT EXISTS advance_amount_cad NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS advance_paid_inr NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS estimated_weight NUMERIC DEFAULT 1.0,
ADD COLUMN IF NOT EXISTS estimated_cost_cad NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS actual_weight NUMERIC,
ADD COLUMN IF NOT EXISTS final_cost_cad NUMERIC,
ADD COLUMN IF NOT EXISTS remaining_balance_cad NUMERIC DEFAULT 0,
